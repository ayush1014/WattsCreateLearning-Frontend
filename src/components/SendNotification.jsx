...
export default function SendNotification() {
  ...
  return (
    <>
      ...
      >
        <div style={{zIndex:'-1', paddingTop:'100px', paddingRight:'10%'}}className="flex w-full flex-col items-center space-y-4 sm:items-end">
              ...
              <div className="p-4">
                <div className="flex items-center">
                  <div className="flex w-0 flex-1 justify-between">
                    <p className="w-0 flex-1 text-sm font-medium text-gray-900">Message Sent Successfully!</p>
                    {/* <button
                      type="button"
