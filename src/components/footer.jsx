  ...
  return (
    <footer className="bg-white">
      <Modal show={facebookShow} onHide={handleFacebookClose}>
        ...
        <Modal.Body className='text-xl'><span style={{ color: '#626D7B', fontSize: '100%', fontWeight: '600' }}>Watts Create Learning</span> is coming soon on <span style={{ color: 'rgb(46, 68, 133)', fontWeight: '600' }}>Facebook</span></Modal.Body>
        <Modal.Footer>
      ...
      <Modal show={instaShow} onHide={handleInstaClose}>
        ...
        <Modal.Body className='text-xl'><span style={{ color: '#626D7B', fontSize: '100%', fontWeight: '600' }}>Watts Create Learning</span> is coming soon on <span style={{ color: 'rgb(224,41,98)', fontWeight: '600' }}>Instagram</span></Modal.Body>
        <Modal.Footer>
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 flex justify-center space-x-10">
          {socialIcons.map((item) => (
            <a key={item.name}
              href={item.href}
              {...(socialIcons.name === 'LinkedIn' ? { target: "_blank", rel: "noopener noreferrer" } : {})}
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; {new Date().getFullYear()} Watts Creates Learning, All rights reserved.
        </p>
