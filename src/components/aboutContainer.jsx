        ...
        <div className="bg-white">
            ...
            <main className="isolate">
                ...
                <Modal show={facebookShow} onHide={handleFacebookClose}>
                    ...
                    <Modal.Body className='text-xl'><span style={{ color: 'rgba(214,165,187)', fontSize: '100%', fontWeight: '600' }}>Watts Create Learning</span> is coming soon on <span style={{ color: 'rgb(46, 68, 133)', fontWeight: '600' }}>Facebook</span></Modal.Body>
                    <Modal.Footer>
                ...
                {/* <Modal show={instaShow} onHide={handleInstaClose}>
                    ...
                    <Modal.Body className='text-xl'><span style={{ color: 'rgba(214,165,187)', fontSize: '100%', fontWeight: '600' }}>Watts Create Learning</span> is coming soon on <span style={{ color: 'rgb(224,41,98)', fontWeight: '600' }}>Instagram</span></Modal.Body>
                    <Modal.Footer>
                ...
                <div className="mx-auto mt-24 max-w-6xl px-6 sm:mt-12 lg:px-8">
                    <div className="mx-auto max-w-6xl lg:mx-0">
                        ...
                        <p style={{ fontFamily: 'playfair', fontStyle: 'italic', fontWeight: '650' }} className="mt-6 text-2xl leading-8 text-gray-600">
                    ...
                    <div className="mx-auto max-w-max lg:max-w-7xl">
                        <div className="relative z-10 mb-8 md:mb-2 md:px-6">
                            <div className="max-w-prose text-base lg:max-w-none">
                                <p className="mt-4 text-5xl font-bold leading-8 tracking-tight text-gray-900 sm:text-7xl">
