    ...
    <div className='test'>
      <div>
        ...
        <Modal show={facebookShow} onHide={handleFacebookClose}>
          ...
          <Modal.Body className='text-xl'><span style={{ color: 'rgba(35,71,130)', fontSize: '100%', fontWeight: '600' }}>Watts Create Learning</span> is coming soon on <span style={{ color: 'rgb(46, 68, 133)', fontWeight: '600' }}>Facebook</span></Modal.Body>
          <Modal.Footer>
        ...
        <Modal show={instaShow} onHide={handleInstaClose}>
          ...
          <Modal.Body className='text-xl'><span style={{ color: 'rgba(35,71,130)', fontSize: '100%', fontWeight: '600' }}>Watts Create Learning</span> is coming soon on <span style={{ color: 'rgb(224,41,98)', fontWeight: '600' }}>Instagram</span></Modal.Body>
          <Modal.Footer>
